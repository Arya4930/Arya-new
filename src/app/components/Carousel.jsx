...
export default function HackathonCarousel() {
    const projects = [
        { title: "UniCC", desc: "UniCC is a web application designed specifically for students of VIT Chennai. It provides a clean, minimalist interface to access campus-related information such as attendance, grades, schedules, hostel status, and file storage.", link: "https://github.com/Arya4930/UniCC", color: "#0044ff" },
        ...
        { title: "Personal Website", desc: "The website you are currently on!", link: "https://github.com/Arya4930/Arya-new", color: "#d1f00d" },
    ...
    const getGradient = (color) => {
        const endColor = color || "#ffffff";
        return `linear-gradient(135deg, #f3f4f6 0%, ${endColor} 100%)`;
    };
                        ...
                        <SwiperSlide key={index} className="overflow-visible py-1">
                            ...
                            >
                                <motion.div
                                    ...
                                    style={{ background: getGradient(project.color) }}
                                    className="relative rounded-xl p-6 h-[140px] flex flex-col justify-center cursor-pointer shadow-sm hover:shadow-lg transition-all duration-300"
                                >
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-800">
                                        {project.title}
                                    </h3>

                                    <p className="text-sm text-gray-800 dark:text-gray-800 mt-2 line-clamp-3">
                                        {project.desc}
                                    </p>
                                </motion.div>
                            </a>
